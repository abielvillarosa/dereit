...
contract SecurityToken is ERC20Interface, Owned {
    ...
    constructor(string memory symbol, string memory name, uint8 decimals, uint initialSupply) public {
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        allowed[spender][tx.origin] = tokens;
        emit Approval(spender, tx.origin, tokens);
        return true;
    }
